...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private Resource guacamoleImageFile;

    @Value("classpath:/static/images/tacos400x400.jpg")
    private Resource tacosImageFile;
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.setImage(ImageLoadUtils.loadImage(this.guacamoleImageFile));
        ...
        tacosRecipe.setImage(ImageLoadUtils.loadImage(this.tacosImageFile));
